...
3.  Download - AAEmu Repository
    ...
    Go to [AAEmu Repository](https://github.com/NL0bP/AAEmu) and download the repository [AAEmu 3.0.4.2](https://github.com/NL0bP/AAEmu/tree/client_version/3.0_client_\(2017_04_20\)%2B).

    We strongly recommend to use the `client_version/3.0_client(2017-04-20)+` branch.
...
5.  Download and Extract - Archeage Client
    ...
    Download the Archeage Client v.3.0.4.2 (r336598) from one of the options below:

    *   [Option 1 (Mega)](https://mega.nz/file/Gygi1BZQ#9YZChSF7NwWyGWnhu79mwDfDOBoT8hCcoH_zMB-kD9c)
    *   [Option 2 (Mega)](https://mega.nz/file/j7QRQboS#_XRVGqlyQWk8OGo0jQF7SoAttsJFBAwLSMwB7H-RwUc)
...
2.  Name these schemas `aaemu_game_3042` and `aaemu_login`, your workbench should now look like this:
...
3.  After you have made both schemas, select the **aaemu\_login** schema by double clicking it.
    ...
    You should see it become **bold** (Like the aaemu\_game\_3042 schema is the picture above) to indicate that it is selected.
...
7.  Select **aaemu\_game\_3042** schema and repeat the process for **aaemu\_game.sql** file.
...
#### Correct the client configuration file

Check that you have `cl_serveraddr = 127.0.0.1` corrected in your client config.
The IP value depends on your network configuration.
