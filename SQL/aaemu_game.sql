...
CREATE TABLE `attendances`  (
  ...
  `account_attendance` datetime NULL DEFAULT NULL,
...
CREATE TABLE `characters`  (
  ...
  `heir_level` tinyint NOT NULL DEFAULT 0,
  `heir_exp` int UNSIGNED NOT NULL DEFAULT 0,
  `hp` int NOT NULL,
  `mp` int NOT NULL,
  ...
  `rez_time` datetime NULL DEFAULT NULL,
  ...
  `delete_request_time` datetime NULL DEFAULT NULL,
  `transfer_request_time` datetime NULL DEFAULT NULL,
...
CREATE TABLE `expeditions`  (
  ...
  `protect_time` datetime NULL DEFAULT NULL,
  `war_deposit` int NOT NULL DEFAULT 0,
  `daily_exp` int NOT NULL DEFAULT 0,
  `last_exp_update_time` datetime NULL DEFAULT NULL,
...
CREATE TABLE `items`  (
  ...
  `unsecure_time` datetime NULL DEFAULT NULL,
  `unpack_time` datetime NULL DEFAULT NULL,
  `owner` int UNSIGNED NOT NULL,
  ...
  `freshness_time` datetime NULL DEFAULT NULL,
  `charge_use_skill_time` datetime NULL DEFAULT NULL,
  `charge_start_time` datetime NULL DEFAULT NULL,
  `charge_proc_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `skill_active_types` (
