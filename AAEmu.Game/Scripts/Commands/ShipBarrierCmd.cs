...
/// Uses only <see cref="InstanceWorld"/> public barrier helpers so Roslyn script compilation (compiler-check) succeeds.
/// </summary>
public sealed class ShipBarrierCmd : ICommand
{
    ...
    private void HandleReset(Character character, InstanceWorld world, string[] args, IMessageOutput messageOutput)
    {
    ...
    private void SendStatus(InstanceWorld world, IMessageOutput messageOutput)
    {
