    ...
    public class AddKit : ICommand
    {
        ...
        public class GMItemKitItem
        {
            ...
            public GMItemKitItem()
            {
                ...
                itemId = 0;
                itemGrade = ItemGrade.Crude;
                itemCount = 1;
            }

            public GMItemKitItem(string kit, uint id, ItemGrade grade = ItemGrade.Crude, int count = 1)
            {
                this.kitnames.Clear();
        ...
        public void Execute(Character character, string[] args)
        {
            ...
            foreach (var kit in kitconfig.itemkits)
            {
                ...
                {
                    if (!targetPlayer.Inventory.Bag.AcquireDefaultItem(ItemTaskType.Gm, kit.itemId, kit.itemCount, (int)kit.itemGrade))
                    {
