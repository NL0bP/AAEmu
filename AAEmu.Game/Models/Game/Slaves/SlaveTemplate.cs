...
namespace AAEmu.Game.Models.Game.Slaves
{
    public class SlaveTemplate
    {
        ...
        //public uint SlaveInitialItemPackId { get; set; } // отсутствует в 0.5.101.406
        //public uint SlaveCustomizingId { get; set; } // отсутствует в 0.5.101.406
        //public bool Customizable { get; set; } // отсутствует в 0.5.101.406
