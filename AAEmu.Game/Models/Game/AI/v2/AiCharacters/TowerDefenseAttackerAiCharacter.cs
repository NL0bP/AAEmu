...
/// <summary>
/// AI character for tower defense attackers. Builds the state machine and custom combat transition.
/// </summary>
public class TowerDefenseAttackerAiCharacter : NpcAi
{
    /// <summary>
    /// Builds the state machine for the Tower Defense Attacker AI.
