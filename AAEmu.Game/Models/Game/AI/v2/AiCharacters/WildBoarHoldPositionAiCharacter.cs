...
/// <summary>
/// AI character for wild boars that hold their position. Builds the state machine and custom combat transition.
/// </summary>
public class WildBoarHoldPositionAiCharacter : NpcAi
{
    /// <summary>
    /// Builds the state machine for the Wild Boar Hold Position AI.
    ...
    // Optionally override GoToIdle to use HoldPosition state as idle
