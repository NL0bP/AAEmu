...
/// <summary>
/// AI character for big monsters that hold their position. Builds the state machine and custom combat transition.
/// </summary>
public class BigMonsterHoldPositionAiCharacter : NpcAi
{
    /// <summary>
    /// Builds the state machine for the Big Monster Hold Position AI.
    ...
    /// <summary>
    /// Switches the AI to the BigMonsterAttack behavior (combat mode).
    /// </summary>
