...
/// <summary>
/// AI character for NPCs that hold their position. Builds the state machine and custom combat transition.
/// </summary>
public class HoldPositionAiCharacter : NpcAi
{
    /// <summary>
    /// Builds the state machine for the Hold Position AI.
