...
/// <summary>
/// Default AI character for generic NPCs. Builds the state machine and custom combat transition.
/// </summary>
public class DefaultAiCharacter : NpcAi
{
    /// <summary>
    /// Builds the state machine for the Default AI.
    ...
    protected override void Build()
    {
        ...
        // DoNothing state with transitions
    ...
    // Optionally override GoToIdle to use DoNothing state as idle
