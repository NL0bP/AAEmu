    ...
    class MailForSpeciality : BaseMail
    {
        ...
        public bool FinalizeForSeller()
        {
            ...
            else
            {
                ...
                if (itemGrade <= 0)
                    itemGrade = 0;
                var newItem = ItemManager.Instance.Create(_itemToSend, _itemCountSeller, (ItemGrade)itemGrade, true);
        ...
        public bool FinalizeForCrafter()
        {
            ...
            else
            {
                ...
                if (itemGrade <= 0)
                    itemGrade = 0;
                var newItem = ItemManager.Instance.Create(_itemToSend, _itemCountCrafter, (ItemGrade)itemGrade, true);
                newItem.OwnerId = _sender.Id;
                newItem.SlotType = SlotType.Mail;
                Body.Attachments.Add(newItem);
