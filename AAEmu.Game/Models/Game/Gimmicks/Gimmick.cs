...
namespace AAEmu.Game.Models.Game.Gimmicks
{
    public class Gimmick : Unit
    {
        ...
        public ulong EntityGuid { get; set; } // TODO это не Guid в GameObject
        ...
        public new float Scale { get; set; } = 1f; // TODO есть Scale в BaseUnit
        ...
        public PacketStream Write(PacketStream stream)
        {
            ...
            stream.Write("");         //stream.Write((short)0);   // ModelPath
