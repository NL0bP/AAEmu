...
public class WorldCell
{
    ...
    private bool LoadCellHeightMapFromClientData()
    {
        ...
        // TODO: Port GetWorldsByTemplate from nikes, then update physics heightmaps
        // In nikes this iterates WorldInstance objects via WorldManager.Instance.GetWorldsByTemplate(Template.Id)
        // and calls worldInstance.Physics?.UpdateHeightMapFromCellBody(this) and worldInstance.Water.AddFromCellData(this)
        // Our World class needs a Template property and WorldManager needs GetWorldsByTemplate()
