...
public class GameNetwork : Singleton<GameNetwork>
{
    ...
    private GameNetwork()
    {
        ...
        RegisterPacket(CSOffsets.CSRequestPermissionToPlayCinemaForDirectingMode, 5, typeof(CSRequestPermissionToPlayCinemaForDirectingMode));
        ...
        RegisterPacket(CSOffsets.CSRequestCommonFarmList, 5, typeof(CSRequestCommonFarmList));
        ...
        RegisterPacket(CSOffsets.CSEndMusicPacket, 5, typeof(CSEndMusicPacket));

        RegisterPacket(CSOffsets.CSExitBeautySalonPacket, 5, typeof(CSExitBeautySalonPacket));
