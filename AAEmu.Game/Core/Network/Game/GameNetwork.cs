...
public class GameNetwork : Singleton<GameNetwork>
{
    ...
    private GameNetwork()
    {
        ...
        //RegisterPacket(CSOffsets.off_39E9A31C, 5, typeof(off_39E9A31C));
        RegisterPacket(CSOffsets.CSStoppedCinemaPacket, 5, typeof(CSStoppedCinemaPacket));
        ...
        RegisterPacket(CSOffsets.CSRequestHousingRebuildingTaxInfoPacket, 5, typeof(CSRequestHousingRebuildingTaxInfoPacket));
        ...
        RegisterPacket(CSOffsets.CSRequestPlantingPacket, 5, typeof(CSRequestPlantingPacket));
