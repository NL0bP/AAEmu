                ...
                using (var command = connection.CreateCommand())
                {
                    ...
                    using (var reader = new SQLiteWrapperReader(sqliteDataReader))
                    {
                        while (reader.Read())
                        {
                            ...
                            //template.NoCollision = reader.GetBoolean("no_collision", true); // отсутствует в 0.5.101.406
                            //template.RestrictZoneId = reader.IsDBNull("restrict_zone_id") ? 0 : reader.GetUInt32("restrict_zone_id"); // отсутствует в 0.5.101.406
                ...
                using (var command = connection.CreateCommand())
                {
                    ...
                    using (var reader = new SQLiteWrapperReader(command.ExecuteReader()))
                    {
                        while (reader.Read())
                        {
                            ...
                            //func.ShowTip = reader.GetBoolean("show_tip", true); // отсутствует в 0.5.101.406
                            //func.ShowEndTime = reader.GetBoolean("show_end_time", true); // отсутствует в 0.5.101.406
                            //func.Tip = reader.GetString("tip"); // отсутствует в 0.5.101.406
                ...
                using (var command = connection.CreateCommand())
                {
                    ...
                    using (var reader = new SQLiteWrapperReader(command.ExecuteReader()))
                    {
                        while (reader.Read())
                        {
                            ...
                            //func.CurrencyId = reader.GetUInt32("currency_id"); // отсутствует в 0.5.101.406
