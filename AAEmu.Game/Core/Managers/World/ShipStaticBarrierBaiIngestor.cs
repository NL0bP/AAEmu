...
internal static class ShipStaticBarrierBaiIngestor
{
    ...
    public static void EnsureCell(InstanceWorld world, int cellX, int cellY)
    {
    ...
    private static void TryAddMissionReaderLayers(InstanceWorld world, AreasMissionReader reader, BaiLayers enabled)
    {
