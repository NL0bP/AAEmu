...
public static class WaterDebugSnapshot
{
    ...
    public static IEnumerable<string> Capture(InstanceWorld world, Vector3 pos, bool includeClientDump)
    {
        var w = world.Water;
    ...
    public static string CaptureOneLine(InstanceWorld world, Vector3 pos)
    {
        var isW = world.IsWater(pos, out var flow);
    ...
    private static IEnumerable<string> CaptureCellClientWaterDump(WorldCell cell)
    {
        ...
        {
            if (p is not global::AAEmu.Game.Models.CryEngine.Objects.ObjectDataType11Water w)
                continue;
            n++;
            switch (w.VolumeType)
            {
                case global::AAEmu.Game.Models.CryEngine.Objects.WaterObjectVolumeType.River: river++; break;
                case global::AAEmu.Game.Models.CryEngine.Objects.WaterObjectVolumeType.Area: area++; break;
                case global::AAEmu.Game.Models.CryEngine.Objects.WaterObjectVolumeType.Ocean: ocean++; break;
                case global::AAEmu.Game.Models.CryEngine.Objects.WaterObjectVolumeType.Sector: sector++; break;
            }
        }
