...
public static class CSOffsets
{
    ...
    public const ushort CSPauseUserMusicPacket = 0x052; // CSEndMusicPacket
    ...
    public const ushort CSICSMenuListRequestPacket = 0x00E; // CSICSMenuListPacket
    public const ushort CSICSGoodsListRequestPacket = 0x12E; // CSICSGoodsListPacket
    public const ushort CSICSBuyGoodRequestPacket = 0x05B; // CSICSBuyGoodPacket
    ...
    public const ushort CSBeautyShopDataPacket = 0x0D4; // CSBeautyshopDataPacket
    ...
    public const ushort CSExpeditionCreatePacket = 0x01B; // CSCreateExpeditionPacket
    public const ushort CSExpeditionChangeRolePolicyPacket = 0x08D; // CSChangeExpeditionRolePolicyPacket
    public const ushort CSExpeditionChangeMemberRolePacket = 0x0B8; // CSChangeExpeditionMemberRolePacket
    public const ushort CSExpeditionChangeOwnerPacket = 0x02B; // CSChangeExpeditionOwnerPacket
    public const ushort CSChangeNationOwnerPacket = 0x112;
    public const ushort CSExpeditionRenamePacket = 0x13C; // CSRenameFactionPacket CSRenameExpeditionPacket
    public const ushort CSExpeditionDismissPacket = 0x0CD; // CSDismissExpeditionPacket
    public const ushort CSExpeditionInvitePacket = 0x0F7; // CSInviteToExpeditionPacket
    public const ushort CSExpeditionLeavePacket = 0x152; // CSLeaveExpeditionPacket
    public const ushort CSExpeditionKickPacket = 0x178; // CSKickFromExpeditionPacket
    ...
    public const ushort CSLeaveBeautyShopPacket = 0x09C; // CSExitBeautySalonPacket
    ...
    public const ushort CSDetachFromDoodadPacket = 0x048; // CSUnbondDoodadPacket
    ...
    public const ushort CSExecuteCraftPacket = 0x149; // CSExecuteCraft
    ...
    public const ushort CSChangeExpeditionMemberRolePacket = 0xfff; // CSExpeditionMemberRolePacket
    public const ushort CSChangeExpeditionOwnerPacket = 0xfff; // CSExpeditionChangeOwnerPacket
    public const ushort CSChangeExpeditionRolePolicyPacket = 0xfff; // CSExpeditionChangeRolePolicyPacket
    ...
    public const ushort CSCreateExpeditionPacket = 0xfff; // CSExpeditionCreatePacket
    //public const ushort CSDiscardSlavePacket = 0x03D;
    public const ushort CSDismissExpeditionPacket = 0xfff; // CSExpeditionDismissPacket
    public const ushort CSFactionDeclareHostilePacket = 0xfff;
    public const ushort CSHangPacket = 0xfff;
    public const ushort CSInviteToExpeditionPacket = 0xfff; // CSExpeditionInvitePacket
    public const ushort CSJuryVerdictPacket = 0xfff;
    public const ushort CSKickFromExpeditionPacket = 0xfff; // CSExpeditionKickPacket
    public const ushort CSLeaveExpeditionPacket = 0xfff; // CSExpeditionLeavePacket
    public const ushort CSListCharacterPacket = 0xfff;
    public const ushort CSQuestStartWithPacket = 0xfff;
    public const ushort CSRenameExpeditionPacket = 0xfff; // CSRenameFactionPacket CSRenameExpeditionPacket
