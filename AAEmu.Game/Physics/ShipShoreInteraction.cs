...
public sealed class ShipShoreInteraction
{
    ...
    /// <summary>
    /// Resolves terrain contacts for all ships in the list. Called from PhysicsManager after ship-to-ship interactions.
    /// </summary>
    public void ResolveAll(InstanceWorld world, IReadOnlyList<Slave> ships, TimeSpan deltaTime)
    {
        ...
        foreach (var ship in ships)
        {
            ...
            ResolveTerrainContacts(ship, deltaTime, ship.RigidBody.World);
        }
