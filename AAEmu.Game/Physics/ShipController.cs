...
public class ShipController(World world, ShipModel shipModel)
{
    private readonly World _world = world ?? throw new ArgumentNullException(nameof(world));

    public RigidBody Hull { get; private set; } = null!;
    public ShipModel ShipModel { get; init; } = shipModel ?? throw new ArgumentNullException(nameof(shipModel));
