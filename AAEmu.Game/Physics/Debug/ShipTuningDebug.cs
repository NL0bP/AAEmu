...
public static class ShipTuningDebug
{
    ...
    private static void UpdateMarker(InstanceWorld world, MarkerSet set, int idx, uint templateId, uint zoneId, Vector3 pos)
    {
    ...
    {
        return CharacterManager.GetEffectiveAccessLevel(c) >= MinAccessLevel;
    }
